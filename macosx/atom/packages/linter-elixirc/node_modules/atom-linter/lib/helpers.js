...
module.exports = {
  exec: exec, execNode: execNode, rangeFromLineNumber: rangeFromLineNumber,
  find: find, findAsync: findAsync, createElement: createElement,
  parse: parse, tempFile: tempFile,
