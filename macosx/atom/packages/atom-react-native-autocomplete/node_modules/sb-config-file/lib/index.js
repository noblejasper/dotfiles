  ...
  _createClass(ConfigFile, [{
    ...
    value: function () {
      var _ref = _asyncToGenerator(function* () {
        ...
        return this._get(key, defaultValue, (yield Helpers.readFile(this.filePath, this.initialValue)));
      });
    ...
    value: function () {
      var _ref2 = _asyncToGenerator(function* (key, value) {
        ...
        yield Helpers.writeFile(this.filePath, this._set(key, value, strict, (yield Helpers.readFile(this.filePath, this.initialValue))), this.config);
      });
    ...
    value: function () {
      var _ref3 = _asyncToGenerator(function* (key) {
        ...
        yield Helpers.writeFile(this.filePath, this._delete(key, strict, (yield Helpers.readFile(this.filePath, this.initialValue))), this.config);
      });
    ...
    value: function () {
      var _ref4 = _asyncToGenerator(function* (key, value) {
        ...
        yield Helpers.writeFile(this.filePath, this._append(key, value, strict, (yield Helpers.readFile(this.filePath, this.initialValue))), this.config);
      });
