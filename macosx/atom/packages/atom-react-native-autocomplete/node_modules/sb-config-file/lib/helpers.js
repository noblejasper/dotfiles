...
var readFile = exports.readFile = function () {
  var _ref = _asyncToGenerator(function* (filePath, initialValue) {
    var contents = (0, _stripBom2.default)((yield _sbFs2.default.readFile(filePath, 'utf8')));
    try {
...
function readFileSync(filePath, initialValue) {
  var contents = (0, _stripBom2.default)(_sbFs2.default.readFileSync(filePath, 'utf8'));
  try {
    return Object.assign(initialValue, JSON.parse(contents));
  } catch (_) {
    throw new Error('Invalid JSON found at \'' + filePath + '\'');
