...
function install() {
  var givenPackageName = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];
  var promptUser = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
